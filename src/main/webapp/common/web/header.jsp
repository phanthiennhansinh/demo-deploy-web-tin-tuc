...
<!-- Navigation -->
<p style="color: red;text-align: center;">Username: admin - Password: 123456</p>
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
	<div class="container">
		<a class="navbar-brand" href="<c:url value='/trang-chu'/>"><span>Baothanhnien</span><span style="font-size: 12px;">.spring-mvc</span></a>
